...
OUTPUT_DIR="/lustre/fs01/portfolios/dir/projects/dir_arc/evo/checkpoints/40b-train-n256-extension/${TARGET_SEQ_LEN}/zero3/"
mkdir -p $OUTPUT_DIR
MP_SIZE=8
DP_SIZE=256
NUM_WORKERS=-1
...
TARGET_MODEL_CONFIG="/lustre/fs01/portfolios/dir/users/jeromek/savanna-40b-ctx-fixed/configs/40b/model_configs/extension/$TARGET_SEQ_LEN/40b_${TARGET_SEQ_LEN}.yml"
