...
#  cat ../../7b-context-extension-n32-evo1-32K/202411100226/model_configs/7b-evo1-32K.yml | grep -A1 save:
...
MP_SIZE=1
SOURCE_DIR="/lustre/fs01/portfolios/dir/projects/dir_arc/evo/checkpoints/7b-context-extension-n32-linear-64K/7b-linear-64K/202411101820"
SOURCE_DIR="${SOURCE_DIR}/global_step${ITERATION}"
OUTPUT_DIR="${CHECKPOINT_DIR}/7b-context-extension/${ROPE_SCALE}/${TARGET_LEN_STR}/${PREVIOUS_SEQ_LEN_STR}_MP${MP_SIZE}/global_step${ITERATION}"
...
MP_SIZE=8
SOURCE_DIR=$OUTPUT_DIR
OUTPUT_DIR="${CHECKPOINT_DIR}/7b-context-extension/${ROPE_SCALE}/${TARGET_LEN_STR}/MP${MP_SIZE}/global_step${ITERATION}"
