...
#  cat ../../../7b-context-extension-n32-v3-evo1-32K/202411141720/model_configs/7b-evo1-32K.yml | grep -A1 save:
# /lustre/fs01/portfolios/dir/projects/dir_arc/evo/checkpoints/7b-context-extension-n32-v3-evo1-32K/7b-evo1-32K/202411141720
ITERATION=12500
...
MP_SIZE=1
SOURCE_DIR="/lustre/fs01/portfolios/dir/projects/dir_arc/evo/checkpoints/7b-context-extension-n32-v3-hybrid-log_evo1-32K/7b-hybrid-log_evo1-32K/202411220900"
SOURCE_DIR="${SOURCE_DIR}/global_step${ITERATION}"
OUTPUT_DIR="${CHECKPOINT_DIR}/7b-finetune/${TARGET_LEN_STR}/${PREVIOUS_SEQ_LEN_STR}_MP${MP_SIZE}/global_step${ITERATION}"
...
echo "Step 2: Modify ${PREVIOUS_SEQ_LEN_STR} -> ${TARGET_LEN_STR}"

SOURCE_DIR=$OUTPUT_DIR
OUTPUT_DIR="${CHECKPOINT_DIR}/7b-finetune/${TARGET_LEN_STR}/MP1/global_step${ITERATION}"
