...
MP_SIZE=1
SOURCE_DIR="${CHECKPOINT_DIR}/7b-context-extension-n32-evo1-32K/7b-evo1-32K/202411100226/global_step${ITERATION}"
...
OUTPUT_DIR="${CHECKPOINT_DIR}/7b-context-extension/evo1/64K/MP1/global_step${ITERATION}"
...
MP_SIZE=8
SOURCE_DIR=$OUTPUT_DIR
OUTPUT_DIR="${CHECKPOINT_DIR}/7b-context-extension/evo1/64K/MP${MP_SIZE}/global_step${ITERATION}"
