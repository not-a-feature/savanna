...
MP_SIZE=1
SOURCE_DIR="/lustre/fs01/portfolios/dir/projects/dir_arc/evo/checkpoints/7b-context-extension-n32-linear-32K/7b-linear-32K/202411092309/global_step${ITERATION}"
