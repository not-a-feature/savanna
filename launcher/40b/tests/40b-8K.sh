...
#/lustre/fs01/portfolios/dir/users/jeromek/40b-train-extension-n16-40b_8K_mp8cp2-no-async-save-test/202412150842/
#/lustre/fs01/portfolios/dir/users/jeromek/40b-train-extension-n16-40b_8K_mp8cp2-test/202412151242

NODES=(4)
SAVANNA_ROOT=$(realpath ..)
TRAIN_SCRIPT=$SAVANNA_ROOT/train.py
DATA_CONFIG=$SAVANNA_ROOT/configs/40b/data_configs/shortphase_v3_nvidia.yml
CONTEXT_LEN="8K"
