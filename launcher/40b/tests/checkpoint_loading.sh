...
CONTEXT_LEN="8K"
CONFIG="${CONTEXT_LEN}-mp8-cp1-mbs4-ac2"
MODEL_CONFIG=$SAVANNA_ROOT/configs/40b/model_configs/tests/checkpoint_loading/${CONFIG}.yml
