# 40b 256K extension training script, avoid record streams, no recycle events, CP -> 8
...
MODEL_CONFIG=$SAVANNA_ROOT/configs/40b/model_configs/extension/256K/40b_256K.yml
