#/lustre/fs01/portfolios/dir/users/jeromek/7b-context-extension-n32-v3-hybrid-log_evo1-256K/202411280159/
#
NODES=(32)
SAVANNA_ROOT=$(realpath ..)
SCRIPT_DIR=$SAVANNA_ROOT/launcher/7b-context-ext
CONTEXT_LEN="256K"
ROPE_SCALE="hybrid-log_evo1" #ROPE_SCALES=("evo1" "hybrid-log_evo1") 
