...
MODEL_CONFIG=/lustre/fs01/portfolios/dir/users/jeromek/savanna-context-ext/configs/7b-context-ext/model_configs/tests/7b_universal_interleave_mp1.yml
