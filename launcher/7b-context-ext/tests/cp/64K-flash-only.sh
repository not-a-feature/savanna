...
CP_CONFIG="cp2-mp4-mbs2-ac4-ring"
TRAIN_SCRIPT=$SAVANNA_ROOT/train.py
DATA_CONFIG=$SAVANNA_ROOT/configs/7b-context-ext/data_configs/longphase_v3_nvidia.yml
MODEL_CONFIG=$SAVANNA_ROOT/configs/7b-context-ext/model_configs/tests/cp/$CONTEXT_LEN/flash_only/${CP_CONFIG}.yml
...
LAUNCHER=srun
JOBTIME="06:00:00"
SUFFIX="$CONTEXT_LEN-6layer-flash-only-$CP_CONFIG-emb-fix-check"
