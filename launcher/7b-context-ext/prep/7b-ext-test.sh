...
DATA_CONFIG=$SAVANNA_ROOT/configs/7b-context-ext/data_configs/shortphase_test.yml #configs/launcher-test/data_configs/opengenome.yml
ROPE_SCALE=log
#MODEL_CONFIG=$SAVANNA_ROOT/configs/7b-context-ext/model_configs/generated/7b-$ROPE_SCALE-$CONTEXT_LEN.yml
MODEL_CONFIG=$SAVANNA_ROOT/configs/7b-context-ext/model_configs/tests/7b_test.yml #configs/7b-context-ext/model_configs/tests/7b-log-32K-universal.yml
#Containers
...
LAUNCHER=srun
JOBTIME="01:00:00"
SUFFIX="-$ROPE_SCALE-$CONTEXT_LEN-test" #universal"
