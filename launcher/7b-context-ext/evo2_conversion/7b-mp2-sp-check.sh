...
MODEL_CONFIG=$SAVANNA_ROOT/configs/7b-context-ext/model_configs/tests/evo2_conversion/7b_mp2_check.yml
...
OVERRIDES="do_per_ds_valid=False,sequence_parallel=True"
