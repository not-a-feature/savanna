...
from .utils import split_tensor_along_any_dim, split_tensor_along_last_dim
...
def reduce_scatter_to_sequence_parallel_region(input_, seq_dim):
    return _ReduceScatterToSequenceParallelRegion.apply(input_, seq_dim)


def gather_from_sequence_parallel_region(input_, seq_dim):
