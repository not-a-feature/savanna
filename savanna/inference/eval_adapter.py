...
#                         # cont_toks :: [1, seq]
#                         cont_toks = (
#                             torch.tensor(cont_toks, dtype=torch.long).unsqueeze(0).to(multi_logits.device)
#                         )
...
#     adapter = EvalHarnessAdapter(model, forward_step_fn, global_config, batch_size=batch_size)
